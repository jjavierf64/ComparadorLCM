...
def nueva_calibracion():
    ...
    title_label = ttk.Label(ventana_nuevaCalibracion, text="Comparador de bloques TESA", font=("Helvetica", 16, "bold"), background="white")
    ...
    cliente_label = ttk.Label(ventana_nuevaCalibracion, text="Nombre del cliente:", anchor=tk.CENTER, background="white")
    ...
    patron_combobox = ttk.Combobox(ventana_nuevaCalibracion, values=["Bloques Patrón de Cerámica de 0,05\" a 4\"","Bloques Patrón de Cerámica de 0,5 mm a 100 mm"], width=40)
    patron_combobox.grid(row=8, column=1, columnspan=2, pady=5, padx=(20,5), sticky="ew")
    
    material_label = ttk.Label(ventana_nuevaCalibracion, text="Material de los bloques patrón: ", anchor=tk.CENTER, background="white")
    material_label.grid(row=9, column=0, pady=5, sticky=tk.EW)
    material_combobox = ttk.Combobox(ventana_nuevaCalibracion, values=["Patrón en acero","Patrón en Tungsteno", "Patrón en cerámica", "Patrón en cromo"], width=40)
    material_combobox.grid(row=9, column=1, columnspan=2, pady=5, padx=(20,5), sticky="ew")
    
    secuencia_label = ttk.Label(ventana_nuevaCalibracion, text="Secuencia de calibración:", anchor=tk.CENTER, background="white")
    secuencia_label.grid(row=10, column=0, pady=5, sticky=tk.EW)
    secuencia_combobox = ttk.Combobox(ventana_nuevaCalibracion, values=["Desviación central","Desviación central y planitud"], width=40)
    ...
    tEstabilizacion_label = ttk.Label(ventana_nuevaCalibracion, text="Tiempo de estabilización (en segundos):", background="white")
...
def reanudar_calibracion():
    ...
    title_label = ttk.Label(ventana_reanudar, text="Comparador de bloques TESA", font=("Helvetica", 16, "bold"), background="white")
    title_label.grid(row=0, column=0, columnspan=2, pady=20)
    ...
    certificado_label = ttk.Label(ventana_reanudar, text="Seleccione la calibración a reanudar:", anchor=tk.CENTER, background="white")
    ...
    tEstabilizacion_label = ttk.Label(ventana_reanudar, text="Tiempo de estabilización (en segundos):", background="white")
    ...
    regresar_button = ttk.Button(ventana_reanudar, text="Regresar al menú de opciones", command=lambda: regresarVentanaPrincipal(root,ventana_reanudar))
...
def ingresar_cliente():
    ...
    title_label = ttk.Label(ventana_cliente, text="Comparador de bloques TESA", font=("Helvetica", 16, "bold"), background="white")
    title_label.grid(row=0, column=0, columnspan=2, pady=20)
    ...
    contactoCliente_label = ttk.Label(ventana_cliente, text="Tiempo de estabilización (en segundos):", background="white")
    ...
    regresar_button = ttk.Button(ventana_cliente, text="Regresar al menú de opciones", command=lambda: regresarVentanaPrincipal(root,ventana_cliente))
...
def ingresar_calibrando():
    ...
    title_label = ttk.Label(ventana_calibrando, text="Comparador de bloques TESA", font=("Helvetica", 16, "bold"), background="white")
    title_label.grid(row=0, column=0, columnspan=2, pady=20)

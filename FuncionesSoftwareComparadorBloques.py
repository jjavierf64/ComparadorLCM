    ...
    while detenerse == 0:
        ...
        if data != b"":             #Comparación de datos recibidos, vacío hasta que se de la medición
            try:
                ...
                print(divisionDatos)
                medicion=Decimal(divisionDatos[1])    #Pasando de string a decimal
                MedicionBloque=medicion #Guardando dato en lista
...
def AutocompletarInformacionCliente(nombreCliente, direccionCliente, numeroCertificado, numeroSolicitud, identificacionCalibrando, 
    ...
    return hojaResultadosCalibracion
...
def NuevaCalibracion(nombreCliente, numeroCertificado, numeroSolicitud, identificacionCalibrando, 
    ...
    if seleccionSecuencia == "Desviación Central":
        ...
        while ContinuarCalibracion() == True:
            ...
            numColumnaMediciones = 19 # Inicializamos el contador en 19 porque ese es el número de la columna a partir de la cual se empiezan
                                      # a registrar las mediciones de los bloques
            # Se realizan las mediciones del bloque de acuerdo al número de repeticiones
            for numRepeticion in range(numRepeticiones):
    ...
    """
        ...
        # Función de condiciones ambientales
        listaMediciones = Completa1(tiempoinicial, tiempoestabilizacion, numRepeticiones)
